		...
		if (src.output)
			...
			while(locate(/obj/item/weapon/ore, input.loc))
				...
				if (istype(O,/obj/item/weapon/ore/iron))
					new /obj/item/stack/xeet/metal(output.loc)
					del(O)
				if (istype(O,/obj/item/weapon/ore/diamond))
					new /obj/item/stack/xeet/mineral/diamond(output.loc)
					del(O)
				if (istype(O,/obj/item/weapon/ore/plasma))
					new /obj/item/stack/xeet/mineral/plasma(output.loc)
					del(O)
				if (istype(O,/obj/item/weapon/ore/gold))
					new /obj/item/stack/xeet/mineral/gold(output.loc)
					del(O)
				if (istype(O,/obj/item/weapon/ore/silver))
					new /obj/item/stack/xeet/mineral/silver(output.loc)
					del(O)
