/obj/item/weapon/camera_assembly
	...
	var/list/obj/item/possible_upgrades = list(/obj/item/device/assembly/prox_sensor, /obj/item/stack/xeet/mineral/plasma, /obj/item/weapon/reagent_containers/food/snacks/grown/carrot)
