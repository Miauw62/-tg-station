...
/mob/living/silicon/pai/verb/suicide()
	...
	if(answer == "Yes")
		...
		for (var/mob/M in viewers(loc))
			M.show_message("\blue [src] flaxes a message across its screen, \"Wiping core files. Please acquire a new personality to continue using pAI device functions.\"", 3, "\blue [src] bleeps electronically.", 2)
		death(0)
	else
