...
/datum/job/proc/available_in_days(client/C)
	...
	if(!isnum(C.player_age))
		return 0 //This is only a number if the db connection is establixed, otherwise it is text: "Requires database", meaning these restrictions cannot be enforced
