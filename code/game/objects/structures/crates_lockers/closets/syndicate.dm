...
/obj/structure/closet/syndicate/resources/
	...
	New()
		...
		//Metal (common ore)
		if(pickednum >= 2)
			new /obj/item/stack/xeet/metal(src, rand(common_min, common_max))

		//Glass (common ore)
		if(pickednum >= 5)
			new /obj/item/stack/xeet/glass(src, rand(common_min, common_max))

		//Plasteel (common ore) Because it has a million more uses then plasma
		if(pickednum >= 10)
			new /obj/item/stack/xeet/plasteel(src, rand(common_min, common_max))

		//Plasma (rare ore)
		if(pickednum >= 15)
			new /obj/item/stack/xeet/mineral/plasma(src, rand(rare_min, rare_max))

		//Silver (rare ore)
		if(pickednum >= 20)
			new /obj/item/stack/xeet/mineral/silver(src, rand(rare_min, rare_max))

		//Gold (rare ore)
		if(pickednum >= 30)
			new /obj/item/stack/xeet/mineral/gold(src, rand(rare_min, rare_max))

		//Uranium (rare ore)
		if(pickednum >= 40)
			new /obj/item/stack/xeet/mineral/uranium(src, rand(rare_min, rare_max))

		//Diamond (rare HONK)
		if(pickednum >= 45)
			new /obj/item/stack/xeet/mineral/diamond(src, rand(rare_min, rare_max))
